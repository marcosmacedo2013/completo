...
{
	private static final Logger LOG = getLogger( Consumer.class.getName( ) );

	protected static final String AUTHORIZATION = "Authorization";
	protected static final String AUTHORIZATIONUSER = "hitbra";
	...
	private   static final String userName = "hitbra";
	...
	protected static final String BASEURL =  "https://api-dev.hitbra.com.br" ;
	protected static final String URITOKEN =  "/v1/partner/hitbra/authorization/token" ;

	// endPoint - Offer
	protected static final String URICREATEOFFER =  "/v1/partner/hitbra/marketplace/offer/create" ;
	...
	public void getToken( )
	{
		try
		{
			LOG.info( " :: Consumer.getToken() starting ::" );
			System.out.println( " :: Consumer.getToken() starting ::" );
